...
import { Plus, Search, ArrowLeft, Loader2, X } from 'lucide-react';
...
export const SponsoringDashboard = () => {
  ...
  const filteredData = companies.filter(c => {
    const matchesSearch = advancedMatch(c, searchTerm);
      ...
      <Card className="border-0 shadow-lg rounded-2xl overflow-hidden bg-white">
        ...
        <div className="p-4 md:p-5 border-b border-gray-100 flex flex-col md:flex-row gap-3 md:gap-4 items-center justify-between">
          <div className="relative flex-1 w-full">
            ...
            <input 
              type="text" 
              placeholder="Search by company, contact person, email, phone, status..." 
            ...
            {searchTerm && (
              <button
                ...
                className="absolute right-3 top-2.5 md:top-3.5 text-gray-400 hover:text-gray-600 transition-colors"
                title="Clear search"
              >
                <X size={16} />
              </button>
